...
public class GetMyTeacherSlotsHandler
{
    private readonly ILessonSlotRepository _slotRepository;

    public GetMyTeacherSlotsHandler(ILessonSlotRepository slotRepository)
    {
    ...
    {
        var slots = await _slotRepository.GetAllByTeacherAsync(
